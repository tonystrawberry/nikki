  ...
  experience: [
    {
      ...
      highlights: [
        ...
        "Represented Spacely in a <span class=\"text-primary\">TokyoDev</span> interview; wrote <span class=\"text-primary\">four articles</span> for the company tech blog.",
      ],
      stack: [
        "Ruby on Rails",
        "PostgreSQL",
    ...
    },
    {
      ...
      highlights: [
        ...
        "Earned around <span class=\"text-primary\">seven AWS certifications</span> through Monstarlab's certification support — theoretical grounding that's paid dividends ever since.",
  ...
  experience: [
    {
      ...
      highlights: [
        ...
        "Représenté Spacely dans une interview <span class=\"text-primary\">TokyoDev</span> ; rédigé <span class=\"text-primary\">quatre articles</span> pour le blog tech de l'entreprise.",
      ],
      stack: [
        "Ruby on Rails",
        "PostgreSQL",
    ...
    },
    {
      ...
      highlights: [
        ...
        "Obtenu environ <span class=\"text-primary\">sept certifications AWS</span> grâce au programme de l'entreprise — un socle théorique qui paie encore aujourd'hui.",
  ...
  experience: [
    {
      ...
      highlights: [
        ...
        "<span class=\"text-primary\">TokyoDev</span> インタビューで Spacely を代表。社内テックブログに <span class=\"text-primary\">4記事</span>執筆。",
      ],
      stack: [
        "Ruby on Rails",
        "PostgreSQL",
    ...
    },
    {
      ...
      highlights: [
        ...
        "Monstarlab の認定支援プログラムを通じて <span class=\"text-primary\">約7つの AWS 認定</span>を取得 — 理論的基盤がその後も繰り返し活きている。",
