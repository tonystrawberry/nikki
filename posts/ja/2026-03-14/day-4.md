...
title: "4日目"
date: "2026-03-14"
excerpt: "DDIA第4章を読み、Shirimono用Claude SKILLSとSlackベースの自慢サマリー用CLI（brag-slack-cli）を作成"
author: "Tony Duong"
category: "daily"
...
- [DDIA Chapter 4: Encoding and Evolution](/ja/posts/2026-03-14/ddia-chapter-4-encoding-and-evolution) を読んだ — エンコーディング形式（JSON、Protobuf、Avro、Thrift）、スキーマ進化、データフローにおける後方・前方互換性
- Shirimono向けの高品質な日本語練習問題を生成するClaude SKILLSを作成 — Gemini APIを使うよりずっと良い
- パフォーマンスレビュー用にSlackメッセージから実績サマリーを生成するCLIを構築した（[brag-slack-cli](https://github.com/tonystrawberry/brag-slack-cli)）
