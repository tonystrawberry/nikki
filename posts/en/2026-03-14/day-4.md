...
title: "Day 4"
date: "2026-03-14"
excerpt: "Read DDIA ch4, built Claude SKILLS for Shirimono, and a CLI for Slack-based brag summaries (brag-slack-cli)"
author: "Tony Duong"
category: "daily"
...
- read [DDIA Chapter 4: Encoding and Evolution](/en/posts/2026-03-14/ddia-chapter-4-encoding-and-evolution) — encoding formats (JSON, Protobuf, Avro, Thrift), schema evolution, and backward/forward compatibility in data flow
- made Claude SKILLS to help generate high-quality Japanese exercises for Shirimono — way better than using the Gemini API
- built a CLI that generates accomplishment summaries from your Slack messages for performance reviews ([brag-slack-cli](https://github.com/tonystrawberry/brag-slack-cli))

### Example output (Jan 1 – Mar 14, 2026)
