...
title: "Day 1"
date: "2026-03-11"
excerpt: "Reading DDIA, slashing Honeybadger alerts, Claude Code Actions, AI Spec-Driven Development, and progress on Shirimono."
author: "Tony Duong"
category: "daily"
...
- learned that Claude Code Actions is so powerful! We already set up a Github Action to use it to run on every dependabot PR and make it publish a comment explaining the changes, if it's safe to merge or not, etc.
